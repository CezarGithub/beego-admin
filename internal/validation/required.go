...
// - any other types
var Required = &requiredRule{message: "validation.cannot_be_blank", skipNil: false}
...
var NilOrNotEmpty = &requiredRule{message: "validation.cannot_be_blank", skipNil: true}
